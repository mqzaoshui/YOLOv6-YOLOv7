...
'''if __name__ == '__main__':
    ...
    parser.add_argument('--conf-thres', type=float, default=0.45, help='conf threshold for NMS')
...
if __name__ == '__main__':
    ...
    try:
        ...
        torch.onnx.export(model, img, f, verbose=False, opset_version=12, input_names=['images'],
                          output_names=output_names,
                          dynamic_axes={'images': { },  # size(1,3,640,640)
                                        'output': { }} if opt.dynamic and not opt.end2end else None)
