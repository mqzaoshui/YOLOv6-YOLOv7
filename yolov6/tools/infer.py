...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--project', default='runs_s/inference', help='save inference results to project/name.')
    ...
    parser.add_argument('--save-time',action='store_true',help='whether to save thr infer time to txt') #xyh 2022
...
def run(weights=osp.join(ROOT, 'yolov6s.pt'),
    ...
    inferer.infer(conf_thres, iou_thres, classes, agnostic_nms, max_det, save_dir, save_txt, save_img, hide_labels, hide_conf, save_time, view_img)
