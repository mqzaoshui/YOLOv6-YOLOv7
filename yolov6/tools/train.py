...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--batch-size', default=120, type=int, help='total batch size for all GPUs')
    ...
    parser.add_argument('--output-dir', default='./runt/train', type=str, help='path to save outputs')
